...
import '../style/electricBorder.css';
...
const ElectricBorder = ({
  ...
  return (
    ...
    >
      <svg
        ref={svgRef}
        className="electric-border-defs"
        aria-hidden
        focusable="false"
      >
        <defs>
      ...
      <div className="electric-border-layers" style={inheritRadius}>
        <div
          ref={strokeRef}
          className="electric-border-layer box-border"
          style={strokeStyle}
        />
        <div
          className="electric-border-layer box-border"
        ...
        <div
          ...
          style={glow2Style}
        />
        <div className="electric-border-layer" style={bgGlowStyle} />
      </div>

      <div className="electric-border-content" style={inheritRadius}>
        {children}
      </div>
    </div>
  );
