  ...
  return (
    <>
      <section id="projects" className="projects">
        <h2 className="section-title" data-aos="fade-down">{translations.projectsTitle}</h2>
          ...
          {projects.map((project) => (
            <div key={project.id} className="project-card" data-aos="fade-up" data-aos-delay={project.id * 200}>
              ...
              <div className="btn-group">
                <div className="btn">
                  <a href={project.liveDemo} target="_blank" rel="noopener noreferrer">{translations.liveDemo}</a>
                </div>
                <div className="btn">
